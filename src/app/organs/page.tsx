      ...
      <section className="shell">
        ...
        <div className="facts-layout">
          <aside className="facts-sidebar filter-left">
            <FactFilter facts={organsFacts} selectedTag={selectedTag} tagsToShow={tagsLeft} />
          </aside>
          <aside className="facts-sidebar filter-right">
            <FactFilter facts={organsFacts} selectedTag={selectedTag} tagsToShow={tagsRight} />
          </aside>
          <aside className="facts-sidebar filter-top">
            <FactFilter facts={organsFacts} selectedTag={selectedTag} tagsToShow={tagsTop} />
          </aside>
          ...
          <aside className="facts-sidebar filter-bottom">
            <FactFilter facts={organsFacts} selectedTag={selectedTag} tagsToShow={tagsBottom} />
          </aside>
        </div>
      </section>
    </SiteLayout>
